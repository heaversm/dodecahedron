...
/* harmony import */ var dat_gui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
function nextText() {
  gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].killTweensOf(showText);
  gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].delayedCall(DELAY_TIME, showText);
}
...
function update(model) {
  ...
  for (i = 0; i < particleTotal; i++) {
    p = particles[i];
    gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].killTweensOf(p);
    if (i < total) {
      pos = model.paths[i];
      if (pos.type == "a") {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(p, 0.4, {
        x: sw2,
        y: sh2,
        ease: "sine.easein",
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(p, 0.5, {
        delay: 0.3,
        x: pos.x,
        y: pos.y,
        ease: "expo.easeout",
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(p.scale, 0.5, {
        delay: 0.3,
        x: scale,
        y: scale,
        ease: "expo.easeout",
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(p, 0.3, {
        x: sw2,
        y: sh2,
        ease: "sine.easein",
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(p.scale, 0.3, {
        x: 0,
        y: 0,
        ease: "sine.easein",
      });
